...
- WEB интерфейс
- Ранжирование с помощью алгоритма PageRank
- Вывод топ 10 результатов по введенному запросу

#### Входные данные
- файл index.txt из Задания 1
- файлы с html формата unloading_N.html
- результаты векторного поиска из задания 5
...
#### Запуск
- Установите необходимые пакеты: `pip install Flask beautifulsoup4`
- `python app.py`
